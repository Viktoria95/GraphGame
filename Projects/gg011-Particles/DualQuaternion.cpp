...
void DualQuaternion::set(const Egg::Math::float4& orientation, const Egg::Math::float4& translation)
{
	this->orientation = orientation;
	const Egg::Math::float4& q0 = orientation;
	const Egg::Math::float4& t = translation;
	Egg::Math::float4& dq = this->translation;
